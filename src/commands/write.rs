use crate::{AsBytes, Bus, Response, TransferError};
        ...
        WriteBuffer: AsRef<[u8]> + AsMut<[u8]>,
{
    ...
    pub fn write<Reg: Register + Writable>(&mut self, motor_id: u8, data: Reg::INNER) -> Result<Response<()>, TransferError> where Reg::INNER: AsBytes {
        self.write_raw(motor_id, Reg::address(), &data.as_bytes())
    }
}
